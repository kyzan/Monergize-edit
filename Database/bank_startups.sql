...
CREATE TABLE `startups` (
  `su_id` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `su_name` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `registered_email` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `registered_photo` int(11) NOT NULL,
  `linked_accounts` int(11) NOT NULL,
  `locations` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `size` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `tax_owned` int(11) NOT NULL,
  PRIMARY KEY (`su_id`)
